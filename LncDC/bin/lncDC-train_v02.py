...
mrna = '/Users/tomoyauchiyama/lncRNA/reference/gencode.v43.pc_transcripts.fa.gz' # The file with mRNA sequences in fasta format
cds = '/Users/tomoyauchiyama/lncRNA/reference/gencode.v43.cds.fa.gz' # The CDS sequences of the mRNAs in fasta format
lncrna = '/Users/tomoyauchiyama/lncRNA/reference/gencode.v43.lncRNA_transcripts.fa.gz' # The file with lncRNA sequences in fasta format
ss_feature = False #
output_prefix = '/Users/tomoyauchiyama/lncRNA/LncDC/test_v01_230424/test'
thread = 1
...
# %%
dataset[dataset['type'] == 'lncrna'].head()
...
columns = [
    'type','Transcript_length','GC_content', 'Fickett_score', 'ORF_T0_length', 'ORF_T1_length',
...
xgb_model = xgb.XGBClassifier(
    alpha = 10, colsample_bytree = 0.8, gamma = 0.01, learning_rate = 0.1,
...
# %%
    ...
    dataset = train_SIF_PF_extraction.sif_pf_extract(dataset, thread, output_prefix)
    columns = [
        'type', 'Sequence','Transcript_length', 'GC_content', 'Fickett_score', 'ORF_T0_length', 'ORF_T1_length',
        'ORF_T2_length', 'ORF_T0_coverage', 'ORF_T1_coverage', 'ORF_T3_coverage', 'Hexamer_score_ORF_T0',
        'Hexamer_score_ORF_T1', 'Hexamer_score_ORF_T2', 'Hexamer_score_ORF_T3', 'RCB_T0',
        'RCB_T1', 'ORF_T0_PI', 'ORF_T0_MW', 'ORF_T0_aromaticity', 'ORF_T0_instability',
        'ORF_T1_MW', 'ORF_T1_instability', 'ORF_T2_MW', 'ORF_T3_MW'
    ...
    full_columns = [
        'type', 'Transcript_length', 'GC_content', 'Fickett_score', 'ORF_T0_length',
